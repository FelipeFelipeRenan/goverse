...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\x06exists\x18\x01 \x01(\bR\x06exists2\xc0\x02\n" +
	"\vUserService\x12C\n" +
	...
	"\x0eExistsUserByID\x12\x13.user.UserIDRequest\x1a\x18.user.UserExistsResponse\x126\n" +
	"\vGetUserByID\x12\x13.user.UserIDRequest\x1a\x12.user.UserResponseB\x13Z\x11proto/user;userpbb\x06proto3"
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	5, // 4: user.UserService.GetUserByID:input_type -> user.UserIDRequest
	3, // 5: user.UserService.ValidateCredentials:output_type -> user.UserResponse
	3, // 6: user.UserService.GetUserByEmail:output_type -> user.UserResponse
	2, // 7: user.UserService.Register:output_type -> user.RegisterResponse
	6, // 8: user.UserService.ExistsUserByID:output_type -> user.UserExistsResponse
	3, // 9: user.UserService.GetUserByID:output_type -> user.UserResponse
